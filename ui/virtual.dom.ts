...
export interface IVirtualDomAttribute extends IObservable {
        enabled: boolean; // When true, it's added to the UI.
        name: string;
        value: string;
}

export interface IVirtualDomClass extends IObservable {
    name: string;
}
...
export interface IVirtualDomNode extends IObservable {
    classes: Array<IVirtualDomClass>;
    name: string | null;
    nativeNode: any;
    nodes: Array<IVirtualDomNode>;
...
export class VirtualDomNode extends Observable implements IVirtualDomNode {
    classes: Array<IVirtualDomClass> = [];
    name: string | null;
